...
ssd1306_init:
    mov r0, SSD1306_I2C_ADDRESS
    mov r1, SSD1306_DISPLAYOFF
    call i2c_master_write2
    mov r1, SSD1306_SETDISPLAYCLOCKDIV
    call i2c_master_write2
    mov r1, $8000 ;the suggested ratio 0x80
    call i2c_master_write2
    mov r1, SSD1306_SETMULTIPLEX
    call i2c_master_write2
    mov r1, (LCD_HEIGHT - 1) << 8
    call i2c_master_write2
    mov r1, SSD1306_SETDISPLAYOFFSET
    call i2c_master_write2
    clr r1 ; no offset
    call i2c_master_write2
    mov r1, SSD1306_SETSTARTLINE ; line 0
    call i2c_master_write2
    mov r1, SSD1306_CHARGEPUMP
    call i2c_master_write2
    mov r1, $1400 ; internal vcc
    call i2c_master_write2
    mov r1, SSD1306_MEMORYMODE
    call i2c_master_write2
    clr r1 ; 0 - act like ks0108
    call i2c_master_write2
    mov r1, SSD1306_SEGREMAP | $100
    call i2c_master_write2
    mov r1, SSD1306_COMSCANDEC
    call i2c_master_write2

    mov r1, SSD1306_SETCOMPINS
    call i2c_master_write2
.if LCD_HEIGHT == 32
    mov r1, $200
    call i2c_master_write2
    mov r1, SSD1306_SETCONTRAST
    call i2c_master_write2
    mov r1, LCD_MAX_CONTRAST << 8
    call i2c_master_write2
.endif
.if LCD_HEIGHT == 64
    mov r1, $1200
...
.endif
    ...
    mov r1, SSD1306_SETPRECHARGE
    call i2c_master_write2
    mov r1, $F100
    call i2c_master_write2
    mov r1, SSD1306_SETVCOMDETECT
    call i2c_master_write2
    mov r1, $4000
    call i2c_master_write2
    mov r1, SSD1306_DISPLAYALLON_RESUME
    call i2c_master_write2
    mov r1, SSD1306_NORMALDISPLAY
    call i2c_master_write2
    mov r1, SSD1306_DEACTIVATE_SCROLL
    call i2c_master_write2
    mov r1, SSD1306_DISPLAYON
    call i2c_master_write2
    ret

lcd_update:
    mov r0, SSD1306_I2C_ADDRESS
    mov r1, SSD1306_COLUMNADDR
    call i2c_master_write2
    clr r1
    call i2c_master_write2
    mov r1, (LCD_WIDTH - 1) << 8
    call i2c_master_write2
    mov r1, SSD1306_PAGEADDR
    call i2c_master_write2
    clr r1
    call i2c_master_write2
.if LCD_HEIGHT == 64
...
.segment bss
lcd_buffer: resb LCD_BUFFER_SIZE
