;; Machine description for Tiny16
...
;; -------------------------------------------------------------------------
;; Tiny16 specific constraints, predicates and attributes
;; -------------------------------------------------------------------------
...
(define_insn "addsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	  (plus:SI
	   ...
	   (match_operand:SI 2 "tiny16_add_operand" "I,N,r")))]
  ""
  "@
  inc\\t%0, %2
  dec\\t%0, -%2
...
(define_insn "subsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r")
	  (minus:SI
	   ...
	   (match_operand:SI 2 "tiny16_sub_operand" "I,r")))]
  ""
  "@
  dec\\t%0, %2
  sub\\t%0, %2")
...
(define_insn "*movsi"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:SI 1 "tiny16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
...
(define_insn "*movqi"
  [(set (match_operand:QI 0 "nonimmediate_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:QI 1 "tiny16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
...
(define_insn "*movhi"
  [(set (match_operand:HI 0 "nonimmediate_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:HI 1 "tiny16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
