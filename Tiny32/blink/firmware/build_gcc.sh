...
/opt2/riscv32i/bin/riscv32-unknown-elf-gcc -march=rv32im -specs=nosys.specs -specs=nano.specs -nodefaultlibs -nostdlib -nostartfiles -o asm/a.out -T ldscript.ld src/start.S $*
retVal=$?
if [ $retVal -ne 0 ]; then
  exit $retVal
fi
