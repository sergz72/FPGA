...
`define ALU_OP_0 'h4000
`define ALU_OP_1 'h8000
`define ALU_OP_2 'h10000
`define ALU_OP_3 'h20000
`define DATA_SELECTOR_0 'h40000
`define DATA_SELECTOR_1 'h80000
`define DATA_SELECTOR_2 'h100000
`define DATA_SELECTOR_3 'h200000
`define HLT 'h400000
`define WFI_ 'h800000
...
`define BR (`SET_PC | `PC_SOURCE_PC_PLUS_IMM12B | `NOSTORE | `ALU_OP_SUB | `ALU_CLK | `REGISTERS_WR_DATA_SOURCE_ALU_OUT | `ALU_OP1_SOURCE_SOURCE1_REG_DATA | `ALU_OP2_SOURCE_SOURCE2_REG_DATA)
