...
`define SLTI (`NOSTORE | `ALU_OP_SUB | `ALU_CLK | `REGISTERS_WR_DATA_SOURCE_SIGNED_LT | `ALU_OP1_SOURCE_SOURCE1_REG_DATA | `ALU_OP2_SOURCE_IMM12I_SIGNED)
`define SLTIU (`NOSTORE | `ALU_OP_SUB | `ALU_CLK | `REGISTERS_WR_DATA_SOURCE_C | `ALU_OP1_SOURCE_SOURCE1_REG_DATA | `ALU_OP2_SOURCE_IMM12I_SIGNED)
...
`define SLT (`NOSTORE | `ALU_OP_SUB | `ALU_CLK | `REGISTERS_WR_DATA_SOURCE_SIGNED_LT | `ALU_OP1_SOURCE_SOURCE1_REG_DATA | `ALU_OP2_SOURCE_SOURCE2_REG_DATA)
`define SLTU (`NOSTORE | `ALU_OP_SUB | `ALU_CLK | `REGISTERS_WR_DATA_SOURCE_C | `ALU_OP1_SOURCE_SOURCE1_REG_DATA | `ALU_OP2_SOURCE_SOURCE2_REG_DATA)
